...
function env_page_navi($before = '', $after = ''/*, $query_name*/) {
	global $wpdb, $wp_query;
	if ($query_name) { $wp_query = $query_name; }
	...
	next_posts_link( __('Next', 'env'), 0 );
	echo '</li>';
	if ($end_page < $max_page) {
		$last_page_text = __( 'Last', 'env' );
